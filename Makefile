...
lint-py:  ## lint python with ruff
	python -m ruff check finance_etl
	python -m ruff format --check finance_etl
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix finance_etl
	python -m ruff format finance_etl
...
test:  ## run python tests
	python -m pytest -v finance_etl/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v finance_etl/tests --cov=finance_etl --cov-report term-missing --cov-report xml
